...
phy_unique_ordered <- phy_unique$Phylum[order(match(phy_unique$Phylum, taxa_phy_plot$Phylum))] 
taxa_phy_plot$Phylum <- factor(taxa_phy_plot$Phylum, levels=phy_unique_ordered)
